...
class SendDBModel {
    ...
    init(userID:String,userName:String,tweet:String,userImageString:String,contentImageString:String) {
...
//    }
    func sendData() {
        ...
        self.db.collection("tweet").document().setData(["userID" : self.userID as Any,"userName" : self.userName as Any,"tweet" : self.tweet as Any,"userImageString" : self.userImageString as Any,"contentImageString": self.contentImageString as Any,"postDate" : Date().timeIntervalSince1970])
    }
    ...
    func sendContentImageData(data:Data) {
