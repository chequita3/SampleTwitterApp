            ...
            if let snapShotDoc = snapShot?.documents{
                ...
                for doc in snapShotDoc{
                    ...
                    if let tweet = data["Tweet"] as? String{
                        ...
                        let itemModel = Item(icon: UserDefaults.standard.object(forKey: "userImageView") as! UIImage, name: UserDefaults.standard.object(forKey: "userName") as! String, tweet: tweet)
